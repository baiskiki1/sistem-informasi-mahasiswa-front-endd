...
<nav class="navbar bg-white p-1">
      <div class="container-fluid">
        <a class="navbar-brand text-light-dark" href="#myCard">Sistem Informasi Mahasiswa</a>
      </div>
    </nav>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    ...
    <nav class="navbar bg-dark p-1">
      <div class="container-fluid">
        <a class="navbar-brand text-light" href="#myCard">Cari Mahasiswa</a>
      </div>
    </nav>
    <form>
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label">Nomor Pokok Mahasiswa</label> 
    <div class="col-8">
